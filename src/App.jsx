...
const PLATOS = {
 ...
 { id:"pr8",e:"🥞",nm:"Tortilla de patata vegana",col:"#2a5a7a",t:"45 min",kal:"260 kcal",nut:"Prot 9g · Carbos 34g · Grasas 10g",compra:["4 — patatas medianas","1 — cebolla grande","1 taza — harina de garbanzo","1 taza — agua","2 cdas. — levadura nutricional","½ cdta. — sal negra kala namak (da sabor a huevo)","½ cdta. — ajo en polvo","½ cdta. — cúrcuma (para el color amarillo)","Pimienta negra al gusto","Aceite de oliva para freír"],receta:["Pelar y cortar las patatas en láminas finas. Picar la cebolla en juliana.","Freír las patatas y la cebolla en abundante aceite a fuego medio durante 15-20 minutos hasta que estén tiernas. Escurrir bien el aceite.","En un bol mezclar la harina de garbanzo, el agua, la levadura nutricional, la sal negra, el ajo en polvo, la cúrcuma y la pimienta. Batir hasta que no haya grumos.","Añadir las patatas y cebolla escurridas a la mezcla. Remover bien para que se integren.","Calentar una sartén antiadherente con un poco de aceite. Verter la mezcla y cocinar a fuego medio-bajo tapado durante 10 minutos.","Dar la vuelta con la ayuda de un plato y cocinar otros 8 minutos por el otro lado.","Dejar reposar 5 minutos antes de cortar. La sal negra le da ese sabor característico a huevo."] },
 ],
 pas:[
...
export default function App() {
 ...
 {card.data.link && <button onClick={()=>window.open(card.data.link,"_blank")} style={{background:"rgba(45,80,22,0.9)",color:"white",border:"none",borderRadius:8,padding:"6px 12px",cursor:"pointer",fontFamily:"system-ui",fontSize:11,fontWeight:600}}>🔗 Más info</button>}

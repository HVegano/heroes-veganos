...
export default function App() {
 ...
 <button onClick={()=>{ const links=["https://buy.stripe.com/5kQ6oI1fE6hF5aoabLc3m01","https://buy.stripe.com/7sY14o9MadK7byM97Hc3m00","https://buy.stripe.com/3cIaEY1fE21pauI0Bbc3m02"]; window.open(links[causa],"_blank"); }} style={{...S.btn("linear-gradient(135deg,#2D5016,#4A7C2F)","white"),width:"100%",fontSize:15,padding:"14px"}}>
